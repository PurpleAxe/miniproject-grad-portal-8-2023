...
import {createInboxCommand, createNotificationsCommand} from 'libs/api/notifications/util/src/commands';
import {INotifications} from 'libs/api/notifications/util/src/interfaces';
import {Notifications} from '../models';

@CommandHandler(createInboxCommand)
export class CreateInboxHandler
  implements ICommandHandler<createInboxCommand>
{
