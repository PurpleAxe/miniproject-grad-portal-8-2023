...
import {
    ...
    // Gender,
    // HouseholdIncome,
    IProfile,      //I'm using the interface from the profiles folder because they should be the same
...
export class UserProfileState {
  constructor(
    private readonly userProfileApi: UserProfilesApi,
  ...
  @Action(Logout)
  async logout(ctx: StateContext<UserProfileStateModel>) {
  ...
  subscribeToUserProfile(ctx: StateContext<UserProfileStateModel>) {
    ...
    return this.userProfileApi
      ...
      .pipe(tap((profile: IProfile) => ctx.dispatch(new SetUserProfile(profile))));
  }

  @Action(SetUserProfile)
  setUserProfile(ctx: StateContext<UserProfileStateModel>, { profile }: SetUserProfile) {
    return ctx.setState(
      produce((draft) => {
...
//   async updateAccountDetails(ctx: StateContext<UserProfileStateModel>) {
//     try {
...
//   async updateContactDetails(ctx: StateContext<UserProfileStateModel>) {
//     try {
//       const state = ctx.getState();
//       const userId = state.profile?.userId;
...
//   async updateAddressDetails(ctx: StateContext<UserProfileStateModel>) {
//     try {
//       const state = ctx.getState();
//       const userId = state.profile?.userId;
...
//   async updatePersonalDetails(ctx: StateContext<UserProfileStateModel>) {
//     try {
//       const state = ctx.getState();
//       const userId = state.profile?.userId;
...
//   async updateOccupationDetails(ctx: StateContext<UserProfileStateModel>) {
//     try {
//       const state = ctx.getState();
//       const userId = state.profile?.userId;
